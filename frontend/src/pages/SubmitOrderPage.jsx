...
const SubmitOrderPage = () => {
    ...
    cart.shippingPrice = cart.itemsPrice < 50 ? round2(cart.itemsPrice * 0.02) : round2(cart.itemsPrice * 0.1)
            ...
            <Col md={8}>
                ...
                <Card className="mb-3">
                    <Card.Body>
                        ...
                        <Col md={6} className='image-container'>Description</Col>
                        ...
                        <Link to="/cart" className='btn btn-light my-3'>Edit cart</Link>
                    </Card.Body>
                </Card>
            </Col>
            <Col md={4}>
